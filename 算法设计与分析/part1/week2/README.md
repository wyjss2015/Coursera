...
The [QuickSort.txt](QuickSort.txt) file contains all of the integers between 1 and 10,000 (inclusive, with no repeats) in unsorted order. The integer in the ith row of the file gives you the ith entry of an input array.
...
##问题二
GENERAL DIRECTIONS AND HOW TO GIVE US YOUR ANSWER: See the first question.
